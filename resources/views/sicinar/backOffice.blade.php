...
<head>
    ...
    <title>@yield('title','BackOffice') | CASCARITA MEXIQUENSE 2022</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="#" class="logo">
            ...
            <span class="logo-lg"><b> CASCARITA MEXIQUENSE 2022</b></span>
        </a>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy;. Derechos reservados. Secretaría de Desarrollo Social - Instituto Mexiquense de la Juventud (IMEJ). 
        </strong>
    </footer>
</div>
<!-- jQuery 3 -->
