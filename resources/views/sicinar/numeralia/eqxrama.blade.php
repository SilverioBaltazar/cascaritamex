...
@section('title','Estadística por rama')
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        ...
        <small>Por Rama</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Menú</a></li>
        <li><a href="#">Estadísticas de Equipos    </a></li>
        <li class="active">Por Rama </li>
      </ol>
    </section>
            ...
            <div class="box-body">
              <table id="tabla1" class="table table-striped table-bordered table-sm">
                <thead style="color: brown;" class="justify">
                  <tr>
                    <th rowspan="2" style="text-align:left;"  >RAMA </th>
                ...
                <tbody>
                  @foreach($regficha as $ficha)
                    <tr>
                      @if($ficha->eq_rama == 'F')
                          <td style="color:darkgreen; text-align:left;">FEMENIL</td>
                      @else
                          @if($ficha->eq_rama == 'V')
                              <td style="color:darkgreen; text-align:lef;">VARONIL </td>
                          @else
                              <td style="color:darkgreen; text-align:left;">** </td>
                          @endif
                      @endif
                      <td style="color:darkgreen; text-align:center;">{{$ficha->total}}</td>
                    </tr>
                  @endforeach
                  @foreach($regtotxrama as $totales)
                     <tr>

                        <td style="color:green;"><b>TOTAL</b> </td>                         
                        <td style="color:green; text-align:center;"><b>{{$totales->totalxrama}} </b></td>
                     </tr>
                  @endforeach
                </tbody>
              </table>
