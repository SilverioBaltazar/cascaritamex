...
@section('content')
    ...
    <table class="table table-hover table-striped" align="center">
        ...
        <tr>
            ...
            <th style="width:440px; text-align:center;"><h4 style="color:black;">Catálogo de Categorias </h4></th>
    ...
    <table class="table table-sm" align="center">
        ...
        <tr>
            ...
            <th style="background-color:darkgreen;text-align:left;width: 300px;"><b style="color:white;font-size: x-small;">Categoria</b></th>
        ...
        <tbody>
            @foreach($regcategoria as $cate)
                <tr>
                    <td style="text-align:justify;vertical-align: middle;width: 5px;"><b style="color:black;font-size: x-small;">{{$cate->cate_id}}</b>
                    </td>
                    <td style="text-align:justify;vertical-align: middle;width: 300px;"><b style="color:black;font-size: xx-small;">{{$cate->cate_desc}}</b>
                    </td>
                    <td style="text-align:center;vertical-align: middle;"><b style="color:black;font-size: x-small;">{{$cate->cate_status}}</b>
                    </td>
                    <td style="text-align:center; vertical-align: middle;"><b style="color:black;font-size: x-small;">{{date("d/m/Y", strtotime($cate->cate_fecreg))}}</b>
                    </td>
                </tr>
            @endforeach
        </tbody>
