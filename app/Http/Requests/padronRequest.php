...
class padronRequest extends FormRequest
{
    public function messages()
    {
        return [
            ...
            'periodo_id2.required'       => 'Año de nacimiento es obligatorio.',
            'mes_id2.required'           => 'Mes de nacimiento es obligatorio.',
            'dia_id2.required'           => 'Día de nacimiento es obligatorio.'
            ...
            //'servicios.required'       => 'Servicios que le brinda la IAP es obligatorio.'
